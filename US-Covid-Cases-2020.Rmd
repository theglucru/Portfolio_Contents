...
us_cases_plot <- ggplot(data = us_2020, mapping = aes(x = date, y = delta_cases))+
  geom_line()

us_cases_plot+labs(title = "Number of New Covid Cases in the US 2020",
                   x = "",
                   y = "New Cases")+
...
```
Notable spikes in July, and end of the year